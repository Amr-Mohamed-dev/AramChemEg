...
const Footer = () => {
  return (
    <div className="px-4 pt-7 mx-auto sm:max-w-xl md:max-w-full lg:w-full md:px-24 lg:px-[10vw] bg-gradient-to-r from-gray-900 via-gray-900 to-indigo-900 text-white">
